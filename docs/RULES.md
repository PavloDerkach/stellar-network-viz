...
## ⚡ ПРАВИЛО #11 - ЯЗЫК ОБЩЕНИЯ

### Оптимизация токенов:

1. **Отвечай на том же языке на котором задается запрос или вопрос**
2. **Все рекомендации по Git коммитам давай на английском**

---

## 🎭 ПРАВИЛО #12 - ТОН ОБЩЕНИЯ
...
2. Ответ КРАТКИЙ и ПО ДЕЛУ
3. Не создано лишнего
4. Всё работает КАК НАДО
5. Можно быстро применить решение

---

**ГЛАВНОЕ ПРАВИЛО:**

# 🎯 ДЕЛАЙ ЧТО ПРОСЯТ, НЕ БОЛЬШЕ, НЕ МЕНЬШЕ!
# 🎯 УТОЧНЯЙ ЧТО НАДО СДЕЛАТЬ ПЕРЕД ВЫПОЛНЕНИЕМ БОЛЬШОГО ОБЪЕМА РАБОТ, ЧТОБ НЕ ТРАТИТЬ ТОКЕНЫ ВПУСТУЮ НА НЕНУЖНЫЕ ДЕЙСТВИЯ!

---

**Версия:** 1.0  
**Дата:** 28.10.2025  
**Обновлять:** При появлении новых правил
